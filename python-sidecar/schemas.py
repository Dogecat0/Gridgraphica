...
class DataCenterSchema(BaseModel):
    ...
    investment: str | None = Field(..., description="Total capital investment or cost of the project (e.g., '$1.2B').")
    squareFootage: float | None = Field(..., description="Physical building size in square feet.")
    ...
    certifications: List[str] = Field(default_factory=list, description="List of certifications or ratings (e.g., LEED Gold, Tier III).")
